...
class ShopHot extends StatefulWidget{
  const ShopHot({Key? key}) : super(key: key);

  @override
  _ShopHotState createState() => _ShopHotState() ;
}
...
class _ShopHotState extends State<ShopHot>{
  ...
  void initState() {
    ...
    Future.delayed(const Duration(milliseconds: 1000), () => initStream());
  }

  void initStream(){
    StickerStorage.getHotStickers((titles) {
    ...
    StickerStorage.getHotEmojis((titles) {
      for(var title in titles ){
              ...
              child: Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [
                      ColorList.getColor(7).withOpacity(0.8),
